...
- Smart Middle-Frame Thumbnail Extractor: Uses OpenCV & Pillow to calculate and extract the exact middle frame (duration / 2.0) of the video, ensuring track title graphics and visualizers are rendered at full opacity.
